...
export interface AtomFamily<Param, AtomType> {
  ...
  setShouldRemove(shouldRemove: ShouldRemove<Param> | undefined): void
}
...
export function atomFamily<Param, AtomType extends Atom<unknown>>(
  ...
  let shouldRemove: ShouldRemove<Param> | undefined = undefined
  ...
  const createAtom = (param: Param) => {
    ...
    atoms.set(param, [newAtom, os.clock()])
    return newAtom
  }
  ...
  createAtom.setShouldRemove = (fn: ShouldRemove<Param> | undefined) => {
    shouldRemove = fn

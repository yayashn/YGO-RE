...
/*
    ...
    increase the ATK of all WATER monsters by 500 points 
    and decrease the ATK of all FIRE monsters by 400 points.
*/

const BUFF_ATK = 500
const BUFF_ATTRIBUTES = ['WATER']

const NERF_ATK = -400
const NERF_ATTRIBUTES = ['FIRE']

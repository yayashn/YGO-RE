...
/*
    As long as this card remains face-up on the field, increase the ATK of all WIND monsters 
    by 500 points and decrease the ATK of all EARTH monsters by 400 points.
*/

const BUFF_ATK = 500
const BUFF_ATTRIBUTES = ['WIND']

const NERF_ATK = -400
const NERF_ATTRIBUTES = ['EARTH']

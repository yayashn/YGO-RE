...
/*
    As long as this card remains face-up on the field, increase the ATK of all DARK monsters 
    by 500 points and decrease the ATK of all LIGHT monsters by 400 points.
*/

const BUFF_ATK = 500
const BUFF_ATTRIBUTES = ['DARK']

const NERF_ATK = -400
const NERF_ATTRIBUTES = ['LIGHT']
